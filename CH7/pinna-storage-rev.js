...
window.onload = function(){//// ref="init1"
  ...
  var Cs = document.querySelectorAll("input[type=\"text\"]");//// ref="selectorAll"
  var Paths = new Array(6).fill(1).map(function() {//// ref="Array.fill"
    return MKSVGElm(Canvas, "path", {"stroke-width": 6, "fill": "none"},{});
  });
  var Color = Storage.C?JSON.parse(Storage.C):["red", "green"];//// ref="getDataFromStorage"
  ...
  function DrawFigs() {//// ref="DrawFigsS"
    var W1=8, W2=4;
    var Color = Array.prototype.map.call(Cs,function(C){return C.value;});//// ref="getDataFromInputs"
