...
\VerbatimInput[
  ...
  numbers=left,firstnumber=1, numbersep=6pt]{#2.ref}
  \gdef\CurrentFile{#2}
...
\VerbatimInput[firstnumber=#3,numbers=left]{\CurrentFile.#1-#2}
%  \listinginput{#3}{\CurrentFile.#1-#2}
  \write\listout{\CurrentFile,#1,#2}
}
\newcommand{\ListSubNN}[4]{%
\VerbatimInput[firstline=#3,lastline=#4, numbers=left]{\CurrentFile.ref}
  \write\listout{\CurrentFile,#1,#2}
}
