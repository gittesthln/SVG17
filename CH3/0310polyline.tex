...
(\Elm{polygon})の違いです。両方のタグも点の位置は\AttribO{points}で指定します。
次の例は正5角形
の頂点を結ぶ図形を描きます。
%\newpage
\ShowFig{0.7}{ht}{polygon5}{\Elm{polygon}の例}{polygon5}
...
\ProbwithFigSol{objects-gradiation}{0.7}{ht}
...
\AttribOVal{miter}{}の欠点は二つの線分の交わる角度が小さいときは先端が鋭く
 ...
 \item その他の値として丸くする\AttribOVal{round}{}と切り捨ててしまう
